    ...
    <div class="main-container d-flex">
        <div class="sidebar" id="side_nav">
            ...
            <ul class="list-unstyled px-2">
                ...
                <li class=""><a href="../view/register student view.php"
                        class="text-decoration-none px-3 py-2 d-block"><i class="fa-solid fa-users"
                ...
                <li class=""><a href="../view/view_recorded_grades.php" class="text-decoration-none px-3 py-2 d-block">
                        <i class="fa-solid fa-users-viewfinder" style="color: #74C0FC;"></i>View Assessment Record</a>
                </li>
                <li class=""><a href="../view/view_student_report.php" class="text-decoration-none px-3 py-2 d-block">
                        <i class="fa-solid fa-users-viewfinder" style="color: #74C0FC;"></i>View Student Reports</a>
                </li>
            </ul>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary bg-light second-navbar">
            ...
            <form class="container-fluid justify-content-evenly" method="post" id='navform'>
                ...
                <button type="submit" name="submit" class="btn btn-lg btn-info btn-outlin-dark"
